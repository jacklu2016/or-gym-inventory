...
def evaluate_agent(agent: BaseAgent,
    ...
    for i in range(n_episodes):
        ...
        try:
            obs, info = eval_env.reset(seed=episode_seed); terminated, truncated = False, False; episode_reward, episode_steps = 0.0, 0
            ...
            while not terminated and not truncated:
                ...
                if t_current < eval_env.num_periods:
                     ...
                     ep_stockout_df.loc[t_current] = eval_env.U.loc[t_current + 1, eval_env.retail_links] # U[t+1] = LS from period t
